    ...
    for epoch in range(args.epochs):
        ...
        for split in splits:
            ...
            if split == 'valid':
                ...
                if not os.path.exists(os.path.join('CVAE/dumps', ts)):
                    os.makedirs('CVAE/dumps/'+ts)
                with open(os.path.join('CVAE/dumps/'+ts+'/valid_E%i.json' % epoch), 'w') as dump_file:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-log', '--logdir', type=str, default='CVAE/logs')
    parser.add_argument('-bin', '--save_model_path', type=str, default='CVAE/bin')
