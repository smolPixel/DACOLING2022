...
from CVAE.utils import to_var


class CVAE(nn.Module):
    def __init__(self, vocab_size, embedding_size, rnn_type, hidden_size, word_dropout, embedding_dropout, latent_size,
                sos_idx, eos_idx, pad_idx, unk_idx, max_sequence_length, num_layers=1, bidirectional=False, num_classes=2):
        ...
        self.latent2hidden = nn.Linear(latent_size+num_classes, hidden_size * self.hidden_factor)
