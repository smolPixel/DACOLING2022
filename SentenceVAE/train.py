    ...
    for epoch in range(args.epochs):
        ...
        for split in splits:
            ...
            if split == 'valid':
                ...
                if not os.path.exists(os.path.join('SentenceVAE/dumps', ts)):
                    os.makedirs('SentenceVAE/dumps/'+ts)
                with open(os.path.join('SentenceVAE/dumps/'+ts+'/valid_E%i.json' % epoch), 'w') as dump_file:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-log', '--logdir', type=str, default='SentenceVAE/logs')
    parser.add_argument('-bin', '--save_model_path', type=str, default='SentenceVAE/bin')
