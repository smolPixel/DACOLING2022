...
from jiant.tasks.lib.trec import trectask
from jiant.tasks.lib.FakeNews import FakeNewstask
from jiant.tasks.lib.Irony import Ironytask
from jiant.tasks.lib.ironyb import ironybtask
from jiant.tasks.lib.Subj import Subjtask
