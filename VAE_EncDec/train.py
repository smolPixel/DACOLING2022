...
def main(args):
    ...
    def loss_fn(logp, target, length, mean, logv, anneal_function, step, k, x0, dataset_length):
        pritn("BITCH")
        ...
        KL_weight = kl_anneal_function(anneal_function, step, k, dataset_length*x0)
        ...
        for split in splits:
            ...
            for iteration, batch in enumerate(data_loader):
                ...
                NLL_loss, KL_loss, KL_weight = loss_fn(logp, batch['target'],
                    batch['length'], mean, logv, args.anneal_function, step, args.k, args.x0, len(data_loader))
